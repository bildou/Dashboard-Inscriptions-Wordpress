...
?>
  <div class="wrap event-dashboard-container">
			...
			<div class="dashboard-card full-width map-widget-container">
    <div class="map-header">
        <h3>Carte Interactive des Inscriptions</h3>
      <div class="map-layer-toggle">
            <input type="checkbox" id="map-layer-switch">
            <label for="map-layer-switch" class="toggle-label">
                <span class="label-text label-departements">Départements</span>
                <span class="label-text label-villes">Villes</span>
            </label>
        </div>
    </div>
    <div id="interactive-map" style="height: 600px; width: 100%; border-radius: 8px; margin-top: 16px;"></div>
</div>
	  
	  <div class="dashboard-card full-width" id="recent-activity-widget">
        <h3>Activité Récente</h3>
        <ul id="recent-activity-feed" class="activity-list">
            <li class="loading-state">Chargement des activités...</li>
        </ul>
    </div>
    
   <script>
// On passe les données PHP à notre script JS pour qu'il puisse les utiliser
var mapData = {
    departments: <?php echo json_encode($department_data); ?>,
    cities: <?php echo json_encode($city_data); ?>
};
</script>
